...
export const SDK_DEPENDENCY_RESOURCES: readonly SdkDependencyResource[] = [
  ...
  },
  {
    ...
    name: 'FBro 环境 SDK',
    version: '135.0.21.2.6.0',
    sdkVersion: '135.0.21',
    platform: 'windows-x64',
    archiveName: 'lingbuilder-fbro-sdk-135.0.21.2.6.0-windows-x64.zip',
    downloadUrl: 'https://msimgimg.xyz/uploads/lingbuilder-fbro-sdk-135.0.21.2.6.0-windows-x64.zip',
    archiveBytes: 225_435_465,
    expandedBytes: 673_802_402,
    fileCount: 473,
    sha256: 'eeb1494cee6eae01cf812dcc817cbed243679f4f84be4f3689f3c6b7c6dc1f12',
