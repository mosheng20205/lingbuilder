...
export const SDK_DEPENDENCY_RESOURCES: readonly SdkDependencyResource[] = [
  {
    ...
    sdkVersion: '150.0.14',
    platform: 'windows-x64',
    archiveName: 'lingbuilder-cef3-sdk-150.0.14-chromium-150.0.7871.129-bridge4-windows-x64.zip',
    downloadUrl: 'https://msimgimg.xyz/uploads/lingbuilder-cef3-sdk-150.0.14-chromium-150.0.7871.129-bridge4-windows-x64.zip',
    archiveBytes: 194_123_697,
    expandedBytes: 473_594_068,
    fileCount: 534,
    sha256: 'ef841c19811ace53e30502ebc6d146aa90305ae969f327ba1199121822d6919b',
