...
export const WIN32_CONTROL_DEFINITIONS: Win32ControlDefinition[] = [
  ...
  control({ type: 'Image', label: '图片框', moduleId: 'lingbuilder.win32.basic', category: '媒体', icon: 'Image', nativeClass: 'STATIC', nativeAdapter: 'image', defaultProps: { content: '', width: 180, height: 140 }, properties: [IMAGE_SOURCE, { key: 'stretch', label: '填充方式', type: 'enum', defaultValue: 'uniform', options: [option('none', '原始大小'), option('fill', '拉伸填满'), option('uniform', '等比适应'), option('uniformToFill', '等比填满')] }], events: [...COMMON_MOUSE_EVENTS] }),
