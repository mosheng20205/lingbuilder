...
export const WIN32_CONTROL_DEFINITIONS: Win32ControlDefinition[] = [
  ...
  control({ type: 'EdgeBrowser', label: 'Edge浏览器', moduleId: 'lingbuilder.edgeview', category: '媒体', icon: 'Globe', nativeClass: 'STATIC', nativeAdapter: 'edgeview-browser', defaultProps: { content: 'Edge浏览器', width: 480, height: 320, background: '#FFFFFF' }, properties: [text('url', '打开地址', 'https://www.baidu.com'), text('cacheDir', '独立缓存目录'), enumProp('proxyMode', '代理模式', 'system', ['system', 'custom'], { system: '跟随系统', custom: '自定义' }), text('proxyServer', '自定义代理地址')], events: EDGEVIEW_CONTROL_EVENTS, requiredLibraries: ['ole32.lib'] }),
