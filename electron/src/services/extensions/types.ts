export type ExtensionPermission = 'workspace.read' | 'workspace.write';
export interface ExtensionCommandContribution { command: string; title: string; category?: string }
export interface ExtensionMenuContribution { menu: string; command: string; when?: string; group?: string }
