  ...
  ...CEF3_SUBMODULES,
  {
    ...
    contributes: {
      ...
      commands: [
        ...
        { name: 'FBro_启用JS扩展', aliases: ['LB_FBro_EnableJsQuery'], signature: 'FBro_启用JS扩展(查询函数名, 取消函数名)', description: '启用页面调用原生函数通道：页面执行 查询函数名(请求文本) 触发“JS扩展调用”事件，用 FBro事件_继续 回传 {"success":true,"result":"..."} 或 {"success":false,"error":"..."}。必须在首个浏览器创建前调用。', insertText: 'FBro_启用JS扩展("lingQuery", "lingQueryCancel")', returnType: '整数型' },
