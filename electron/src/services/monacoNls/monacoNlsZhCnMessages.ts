// 该文件由 scripts/generate-monaco-zh-cn-nls.ts 自动生成，请勿手工编辑。
// 数据来源：node_modules/monaco-editor@0.55.1/dev/vs/nls.messages.zh-cn.js.js（官方简体中文扁平 NLS 表）。
// 升级 monaco-editor 后必须重新运行 npm run monaco:nls-zh-cn，否则索引会与数据表错位（构建门禁会拦截）。

export const MONACO_NLS_SOURCE_VERSION = "0.55.1";
export const MONACO_NLS_SOURCE_VSCODE_REF = "86f5a62f058e3905f74a9fa65d04b2f3b533408e";

export const MONACO_ZH_CN_MESSAGES: readonly (string | null)[] = [
  "{0} ({1})",
  "输入",
  "区分大小写",
  "全字匹配",
