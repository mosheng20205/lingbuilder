...
const EXPECTED_BRIDGE_VERSION = '2.8.0';
...
const IMPLEMENTED_ADVANCED_EXPORTS = new Set([
  ...
  'FBroHsBrowserFrameTianBiao_SetChecked', 'FBroHsBrowserFrameTianBiao_GetChecked',
  'FBroHsBrowserFrameTianBiao_SetSelected', 'FBroHsBrowserFrameTianBiao_GetSelected',
  'FBroHsBrowserFrameTianBiao_SetInnerText', 'FBroHsBrowserFrameTianBiao_GetInnerText',
  'FBroHsBrowserFrameTianBiao_SetOuterText', 'FBroHsBrowserFrameTianBiao_GetOuterText',
  'FBroHsBrowserFrameTianBiao_SetInnerHTML', 'FBroHsBrowserFrameTianBiao_GetInnerHTML',
  'FBroHsBrowserFrameTianBiao_SetOuterHTML', 'FBroHsBrowserFrameTianBiao_GetOuterHTML',
  'FBroHsBrowserFrameTianBiao_SetAttribute', 'FBroHsBrowserFrameTianBiao_GetAttribute',
  'FBroHsBrowserFrameTianBiao_HasAttribute', 'FBroHsBrowserFrameTianBiao_DispatchEvent',
  'FBroHsBrowserFrame_GetSource', 'FBroHsBrowserFrame_GetText',
  'FBroHsBrowserHost_SendKeyEvent', 'FBroHsBrowserHost_SendMouseClickEvent',
  'FBroHsBrowserHost_SendMouseMoveEvent', 'FBroHsBrowserHost_SendMouseWheelEvent',
  'FBroHsBrowserHost_SendTouchEvent',
  ...
  'FBroHsMenuModel_Clear', 'FBroHsMenuModel_GetCount', 'FBroHsMenuModel_AddSeparator',
  'FBroHsMenuModel_AddCheckItem', 'FBroHsMenuModel_AddRadioItem', 'FBroHsMenuModel_Remove',
  'FBroHsMenuModel_GetLable', 'FBroHsMenuModel_SetLable', 'FBroHsMenuModel_GetType',
  'FBroHsMenuModel_GetGroup', 'FBroHsMenuModel_SetGroup', 'FBroHsMenuModel_GetSubMenu',
  'FBroHsMenuModel_IsVisable', 'FBroHsMenuModel_SetVisable', 'FBroHsMenuModel_IsEnable',
  'FBroHsMenuModel_SetEnable', 'FBroHsMenuModel_IsChecked', 'FBroHsMenuModel_SetCheck',
  'FBroHsMenuModel_SetCheckedAt', 'FBroHsMenuModel_HasAccelerator', 'FBroHsMenuModel_HasAcceleratorAt',
  'FBroHsMenuModel_SetAcceleratorAt', 'FBroHsMenuModel_RemoveAccelerator', 'FBroHsMenuModel_RemoveAcceleratorAt',
  'FBroHsMenuModel_GetAccelerator', 'FBroHsMenuModel_GetAcceleratorAt', 'FBroHsMenuModel_SetColor',
  'FBroHsMenuModel_SetColorAt', 'FBroHsMenuModel_GetColorAt', 'FBroHsMenuModel_SetFontList',
  'FBroHsMenuModel_SetFontListAt', 'FBroHsContextMenuParams_pGetLinkUrl', 'FBroHsContextMenuParams_pGetUnfilteredLinkUrl',
  'FBroHsContextMenuParams_pGetSourceUrl', 'FBroHsContextMenuParams_pGetPageUrl', 'FBroHsContextMenuParams_pGetFrameCharset',
  'FBroHsContextMenuParams_pGetFrameUrl', 'FBroHsContextMenuParams_HasImageContents', 'FBroHsContextMenuParams_GetMediaType',
  'FBroHsContextMenuParams_GetMediaStateFlags', 'FBroHsContextMenuParams_GetSelectionText', 'FBroHsContextMenuParams_GetMisspelledWord',
  'FBroHsContextMenuParams_GetDictionarySuggestions', 'FBroHsContextMenuParams_IsEditable', 'FBroHsContextMenuParams_IsSpellCheckEnabled',
  'FBroHsContextMenuParams_GetEditStateFlags', 'FBroHsContextMenuParams_IsCustomMenu',
  'FBroHsDownloadItem_IsInProgress', 'FBroHsDownloadItem_IsComplete', 'FBroHsDownloadItem_IsCanceled',
  'FBroHsDownloadItem_GetPercentComplete', 'FBroHsDownloadItem_GetDownloadId', 'FBroHsDownloadItem_GetCurrentSpeed',
  'FBroHsDownloadItem_GetTotalBytes', 'FBroHsDownloadItem_GetReceivedBytes', 'FBroHsDownloadItem_GetStartTime',
  'FBroHsDownloadItem_GetEndTime', 'FBroHsDownloadItem_GetFullPath', 'FBroHsDownloadItem_GetDownloadURL',
  'FBroHsDownloadItem_GetDownloadOriginalUrl', 'FBroHsDownloadItem_GetSuggestedFileName', 'FBroHsDownloadItem_GetDownloadMimeType',
  'FBroHsDownloadItem_GetContentDisposition',
  'FBroHsResponse_Create', 'FBroHsResponse_IsReadOnly', 'FBroHsResponse_GetError',
  'FBroHsResponse_SetError', 'FBroHsResponse_GetStatus', 'FBroHsResponse_SetStatus',
  'FBroHsResponse_GetStatusText', 'FBroHsResponse_SetStatusText', 'FBroHsResponse_GetMimeType',
  'FBroHsResponse_SetMimeType', 'FBroHsResponse_GetCharset', 'FBroHsResponse_SetCharset',
  'FBroHsResponse_GetURL', 'FBroHsResponse_SetURL', 'FBroHsResponse_GetHeaderByName',
  'FBroHsResponse_SetHeaderByName', 'FBroHsResponse_GetHeaderMap', 'FBroHsResponse_SetHeaderMap_Array',
  'FBroHsResponse_DeleteHeaderMap',
