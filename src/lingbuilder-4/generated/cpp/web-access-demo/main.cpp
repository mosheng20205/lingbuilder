...
#define UNICODE
#endif
#ifndef LINGBUILDER_WEB_HTTP_MODULE
#define LINGBUILDER_WEB_HTTP_MODULE
#endif
#ifndef UNICODE
#define UNICODE
#endif
...
#define UNICODE
#endif
// LingBuilder 模块: 网页访问模块 (lingbuilder.web.http@1.0.0)
// 模块目标: windows-msvc-win32 / windows-msvc-win32
#include "modules/lingbuilder.web.http/include/web_http_bridge.h"
// 模块源码: src/web_http_bridge.cpp
...
static ControlSpec g_controls_0[] = {
    { 1001, 0, L"Label", L"标题标签", L"网页访问模块完整示例", 24, 22, 820, 36, 20, L"Microsoft YaHei UI", false, false, false, 0, 0, RGB(51, 65, 85), RGB(124, 58, 237), RGB(8, 145, 178), RGB(56, 189, 248), 0, 28, 0, 28, 4, 0, 8, RGB(23, 32, 51), RGB(14, 116, 144), 0, RGB(100, 116, 139), 2, 3, RGB(31, 41, 55), true, RGB(248, 250, 252), true, L"", L"", L"", 500, L"", L"text", L"left", 0, 100, 0, 0, 0, L"" },
    { 1002, 0, L"Label", L"操作说明", L"点击按钮执行对应示例；请求状态、响应文本、Cookie、协议头和错误信息输出到调试面板。", 24, 64, 820, 42, 13, L"Microsoft YaHei UI", false, false, false, 0, 0, RGB(51, 65, 85), RGB(124, 58, 237), RGB(8, 145, 178), RGB(56, 189, 248), 0, 28, 0, 28, 4, 0, 8, RGB(23, 32, 51), RGB(14, 116, 144), 0, RGB(100, 116, 139), 2, 3, RGB(31, 41, 55), true, RGB(148, 163, 184), true, L"", L"", L"", 500, L"", L"text", L"left", 0, 100, 0, 0, 0, L"" },
    { 1003, 0, L"Button", L"GET按钮", L"GET 与结果读取", 24, 126, 250, 52, 14, L"Microsoft YaHei UI", false, false, false, 6, 0, RGB(51, 65, 85), RGB(124, 58, 237), RGB(8, 145, 178), RGB(56, 189, 248), 0, 28, 0, 28, 4, 0, 8, RGB(23, 32, 51), RGB(14, 116, 144), 0, RGB(100, 116, 139), 2, 3, RGB(3, 105, 161), false, RGB(255, 255, 255), true, L"", L"", L"", 500, L"", L"push", L"", 0, 100, 0, 0, 0, L"Click=_GET按钮_被单击" },
    { 1004, 0, L"Button", L"POST按钮", L"POST 表单", 302, 126, 250, 52, 14, L"Microsoft YaHei UI", false, false, false, 6, 0, RGB(51, 65, 85), RGB(124, 58, 237), RGB(8, 145, 178), RGB(56, 189, 248), 0, 28, 0, 28, 4, 0, 8, RGB(23, 32, 51), RGB(14, 116, 144), 0, RGB(100, 116, 139), 2, 3, RGB(4, 120, 87), false, RGB(255, 255, 255), true, L"", L"", L"", 500, L"", L"push", L"", 0, 100, 0, 0, 0, L"Click=_POST按钮_被单击" },
    { 1005, 0, L"Button", L"Cookie按钮", L"Cookie 提交与接收", 580, 126, 264, 52, 14, L"Microsoft YaHei UI", false, false, false, 6, 0, RGB(51, 65, 85), RGB(124, 58, 237), RGB(8, 145, 178), RGB(56, 189, 248), 0, 28, 0, 28, 4, 0, 8, RGB(23, 32, 51), RGB(14, 116, 144), 0, RGB(100, 116, 139), 2, 3, RGB(124, 58, 237), false, RGB(255, 255, 255), true, L"", L"", L"", 500, L"", L"push", L"", 0, 100, 0, 0, 0, L"Click=_Cookie按钮_被单击" },
    { 1006, 0, L"Button", L"请求头按钮", L"请求头 / 响应头 / 重定向", 24, 204, 250, 52, 14, L"Microsoft YaHei UI", false, false, false, 6, 0, RGB(51, 65, 85), RGB(124, 58, 237), RGB(8, 145, 178), RGB(56, 189, 248), 0, 28, 0, 28, 4, 0, 8, RGB(23, 32, 51), RGB(14, 116, 144), 0, RGB(100, 116, 139), 2, 3, RGB(180, 83, 9), false, RGB(255, 255, 255), true, L"", L"", L"", 500, L"", L"push", L"", 0, 100, 0, 0, 0, L"Click=_请求头按钮_被单击" },
    { 1007, 0, L"Button", L"全部方法按钮", L"HEAD / PUT / DELETE 等", 302, 204, 250, 52, 14, L"Microsoft YaHei UI", false, false, false, 6, 0, RGB(51, 65, 85), RGB(124, 58, 237), RGB(8, 145, 178), RGB(56, 189, 248), 0, 28, 0, 28, 4, 0, 8, RGB(23, 32, 51), RGB(14, 116, 144), 0, RGB(100, 116, 139), 2, 3, RGB(190, 18, 60), false, RGB(255, 255, 255), true, L"", L"", L"", 500, L"", L"push", L"", 0, 100, 0, 0, 0, L"Click=_全部方法按钮_被单击" },
    { 1008, 0, L"Button", L"高级参数按钮", L"字节集 / 代理 / 全部参数", 580, 204, 264, 52, 14, L"Microsoft YaHei UI", false, false, false, 6, 0, RGB(51, 65, 85), RGB(124, 58, 237), RGB(8, 145, 178), RGB(56, 189, 248), 0, 28, 0, 28, 4, 0, 8, RGB(23, 32, 51), RGB(14, 116, 144), 0, RGB(100, 116, 139), 2, 3, RGB(71, 85, 105), false, RGB(255, 255, 255), true, L"", L"", L"", 500, L"", L"push", L"", 0, 100, 0, 0, 0, L"Click=_高级参数按钮_被单击" },
    { 1009, 0, L"Label", L"高级参数提示", L"高级参数按钮包含示例代理 127.0.0.1:8888，运行前请在源码中替换；全部方法的服务端支持情况可能不同。", 24, 292, 820, 56, 13, L"Microsoft YaHei UI", false, false, false, 0, 0, RGB(51, 65, 85), RGB(124, 58, 237), RGB(8, 145, 178), RGB(56, 189, 248), 0, 28, 0, 28, 4, 0, 8, RGB(23, 32, 51), RGB(14, 116, 144), 0, RGB(100, 116, 139), 2, 3, RGB(31, 41, 55), true, RGB(251, 191, 36), true, L"", L"", L"", 500, L"", L"text", L"left", 0, 100, 0, 0, 0, L"" }
};

static WindowSpec g_windows[] = {
    { 0, L"MainWindow", L"网页访问使用demo主窗口", 900, 532, RGB(31, 41, 55), RGB(45, 45, 48), RGB(203, 213, 225), 2, L"lingbuilder", L"", L"default", CW_USEDEFAULT, CW_USEDEFAULT, true, true, g_controls_0, 9, L"", RGB(255, 255, 255), RGB(0, 0, 0), L"Microsoft YaHei UI", 11, false, false, false, L"Loaded=_MainWindow_创建完毕" }
};
...
protected:
    ...
    void DispatchWindowEvent(const wchar_t* eventName) override {
        std::wstring handler = GetWindowEventHandler(spec_, eventName);
        if (handler == L"_GET按钮_被单击") { GET按钮_被单击(); return; }
        if (handler == L"_POST按钮_被单击") { POST按钮_被单击(); return; }
        if (handler == L"_Cookie按钮_被单击") { Cookie按钮_被单击(); return; }
        if (handler == L"_请求头按钮_被单击") { 请求头按钮_被单击(); return; }
        if (handler == L"_全部方法按钮_被单击") { 全部方法按钮_被单击(); return; }
        if (handler == L"_高级参数按钮_被单击") { 高级参数按钮_被单击(); return; }
    ...
    void DispatchEdgeViewEvent(const wchar_t* handler, int instanceId, const wchar_t* eventName, const wchar_t* data) override {
        ...
        if (callback == L"_GET按钮_被单击") { GET按钮_被单击(); return; }
        if (callback == L"_POST按钮_被单击") { POST按钮_被单击(); return; }
        if (callback == L"_Cookie按钮_被单击") { Cookie按钮_被单击(); return; }
        if (callback == L"_请求头按钮_被单击") { 请求头按钮_被单击(); return; }
        if (callback == L"_全部方法按钮_被单击") { 全部方法按钮_被单击(); return; }
        if (callback == L"_高级参数按钮_被单击") { 高级参数按钮_被单击(); return; }
        if (callback == L"演示_GET与全部结果读取") { 演示_GET与全部结果读取(); return; }
        if (callback == L"演示_POST表单") { 演示_POST表单(); return; }
        if (callback == L"演示_Cookie提交与接收") { 演示_Cookie提交与接收(); return; }
        if (callback == L"演示_请求头响应头和禁止重定向") { 演示_请求头响应头和禁止重定向(); return; }
        if (callback == L"演示_全部HTTP方法") { 演示_全部HTTP方法(); return; }
        if (callback == L"演示_字节集请求体和全部高级参数") { 演示_字节集请求体和全部高级参数(); return; }
        if (callback == L"演示_系统代理和无限等待参数") { 演示_系统代理和无限等待参数(); return; }
...
private:
    ...
    void MainWindow_创建完毕() {
        调试输出(L"网页访问使用demo 已启动。");
        调试输出(L"本项目不会在启动时自动联网，请在代码中按需调用各个演示子程序。");
        调试输出(L"建议先点击“GET 与结果读取”，请求结果会显示在调试输出中。");
    }
    ...
    void 演示_GET与全部结果读取() {
        std::wstring 网址 = L"https://httpbin.org/get?from=LingBuilder";
        std::vector<unsigned char> 返回字节{};
        返回字节 = 网页_访问_对象(网址, 0);
        调试输出(L"GET 状态码：", 网页_取返回状态代码());
        调试输出(L"GET 返回文本：", 网页_取返回文本());
        调试输出(L"GET 返回 Cookie：", 网页_取返回Cookies());
        调试输出(L"GET 返回协议头：", 网页_取返回协议头());
        调试输出(L"GET 错误信息：", 网页_取错误信息());
    }

    void 演示_POST表单() {
        std::wstring 网址 = L"https://httpbin.org/post";
        std::wstring 表单数据 = L"name=LingBuilder&language=LCPP";
        std::vector<unsigned char> 返回字节{};
        返回字节 = 网页_访问_对象(网址, 1, 表单数据);
        调试输出(L"POST 状态码：", 网页_取返回状态代码());
        调试输出(L"POST 返回文本：", 网页_取返回文本());
        调试输出(L"POST 错误信息：", 网页_取错误信息());
    }

    void 演示_Cookie提交与接收() {
        std::wstring 提交Cookie = L"session=LingBuilder; theme=dark";
        std::vector<unsigned char> 返回字节{};
        返回字节 = 网页_访问_对象(L"https://httpbin.org/cookies", 0, L"", 提交Cookie);
        调试输出(L"服务器看到的 Cookie：", 网页_取返回文本());
        返回字节 = 网页_访问_对象(L"https://httpbin.org/cookies/set/demo/LingBuilder", 0);
        调试输出(L"Set-Cookie：", 网页_取返回Cookies());
        调试输出(L"Cookie 请求状态码：", 网页_取返回状态代码());
    }

    void 演示_请求头响应头和禁止重定向() {
        std::wstring 请求头 = L"Accept: application/json\r\nX-LingBuilder-Demo: header-example";
        std::vector<unsigned char> 返回字节{};
        返回字节 = 网页_访问_对象(L"https://httpbin.org/redirect/1", 0, L"", L"", L"", 请求头, L"", 0, true);
        调试输出(L"禁止重定向后的状态码：", 网页_取返回状态代码());
        调试输出(L"响应协议头：", 网页_取返回协议头());
        调试输出(L"请求错误：", 网页_取错误信息());
    }

    void 演示_全部HTTP方法() {
        std::vector<unsigned char> 返回字节{};
        返回字节 = 网页_访问_对象(L"https://httpbin.org/anything", 2);
        调试输出(L"HEAD 状态码：", 网页_取返回状态代码());
        返回字节 = 网页_访问_对象(L"https://httpbin.org/anything", 3, L"method=PUT");
        调试输出(L"PUT 状态码：", 网页_取返回状态代码());
        返回字节 = 网页_访问_对象(L"https://httpbin.org/anything", 4);
        调试输出(L"OPTIONS 状态码：", 网页_取返回状态代码());
        返回字节 = 网页_访问_对象(L"https://httpbin.org/anything", 5);
        调试输出(L"DELETE 状态码：", 网页_取返回状态代码());
        返回字节 = 网页_访问_对象(L"https://httpbin.org/anything", 6);
        调试输出(L"TRACE 状态码：", 网页_取返回状态代码());
        返回字节 = 网页_访问_对象(L"https://httpbin.org", 7);
        调试输出(L"CONNECT 状态码：", 网页_取返回状态代码());
        返回字节 = 网页_访问_对象(L"https://httpbin.org/anything", 8, L"method=PATCH");
        调试输出(L"PATCH 状态码：", 网页_取返回状态代码());
    }

    void 演示_字节集请求体和全部高级参数() {
        std::vector<unsigned char> 原始请求体{};
        std::vector<unsigned char> 返回字节{};
        原始请求体 = 网页_访问_对象(L"https://httpbin.org/bytes/16", 0);
        // 暂不支持的中文 C++ 语句：// 完整参数依次演示：Cookie、请求头、返回占位、禁止重定向、字节集、代理、超时、代理账号、代理模式、对象继承、Cookie 合并、协议头补全和大小写处理。
        // 暂不支持的中文 C++ 语句：// 运行前请把示例代理 127.0.0.1:8888 改成真实代理；对象继承当前使用 0，表示不继承外部 WinHTTP 对象。
        返回字节 = 网页_访问_对象(L"https://httpbin.org/anything", 1, L"", L"session=LingBuilder", L"", L"content-type: application/octet-stream\r\nx-demo: full-options", L"", 0, true, 原始请求体, L"127.0.0.1:8888", 10, L"proxy-user", L"proxy-password", 1, 0, true, true, true);
        调试输出(L"高级参数状态码：", 网页_取返回状态代码());
        调试输出(L"高级参数返回文本：", 网页_取返回文本());
        调试输出(L"高级参数错误：", 网页_取错误信息());
    }

    void 演示_系统代理和无限等待参数() {
        std::vector<unsigned char> 返回字节{};
        // 暂不支持的中文 C++ 语句：// 代理标识为 0 时使用系统默认代理；超时为 -1 时表示尽量无限等待。此示例只用于展示参数，请谨慎实际调用。
        返回字节 = 网页_访问_对象(L"https://httpbin.org/get", 0, L"", L"", L"", L"", L"", 0, false, 返回字节, L"", -1, L"", L"", 0, 0, true, true, true);
        调试输出(L"系统代理请求状态码：", 网页_取返回状态代码());
    }
};
