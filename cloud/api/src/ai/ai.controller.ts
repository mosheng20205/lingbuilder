import { Body, Controller, Delete, Get, Header, Headers, Inject, Param, Post, Res } from '@nestjs/common';
...
export class UsageController {
  constructor(@Inject(BillingService) private readonly billing: BillingService, @Inject(PrismaService) private readonly prisma: PrismaService) {}
